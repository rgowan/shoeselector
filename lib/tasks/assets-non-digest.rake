# in a rake task file 
# StoreIt is the name of the app and needs to be replaced 
...
Rake::Task["assets:precompile"].enhance do
  Rake::Task["shoe_selector:create_non_digest_assets"].invoke
end
 
namespace :shoe_selector do 
  ...
  task :create_non_digest_assets => :"assets:environment"  do    
    ...
    manifest_data["assets"].each do |logical_path, digested_path|
      ...
      if ShoeSelector::Application.config.non_digest_named_assets.any? {|testpath| logical_pathname.fnmatch?(testpath, File::FNM_PATHNAME) }
